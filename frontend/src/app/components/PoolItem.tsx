...
export default function PoolItem({ tokenPair, poolNumber, fee, volume24h, liquidity, apr, token1Image, token2Image }: PoolItemProps) {
    return (
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                ...
                <div className="flex items-center space-x-8">
                    ...
                    <div className="flex space-x-2">
                        <button className="px-4 py-2 bg-purple-600 hover:bg-purple-700 text-white rounded-lg transition-colors">Deposit</button>
                        <button className="px-4 py-2 bg-gray-600 hover:bg-gray-700 text-white rounded-lg transition-colors">Withdraw</button>
                    </div>
                </div>
            </div>
        </div>
