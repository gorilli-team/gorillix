...
class GorillixActionProvider extends actionProvider_1.ActionProvider {
    ...
    async getTotalLiquidityTokenB(walletProvider, args) {
        try {
            ...
            return `Total liquidity TokenA is ${totalLiquidityTokenB}.`;
        }
        catch (error) {
...
__decorate([
    ...
    __metadata("design:paramtypes", [wallet_providers_1.EvmWalletProvider, void 0]),
    __metadata("design:returntype", Promise)
], GorillixActionProvider.prototype, "swapTokenAToTokenB", null);
__decorate([
    (0, actionDecorator_1.CreateAction)({
    ...
    __metadata("design:paramtypes", [wallet_providers_1.EvmWalletProvider, void 0]),
    __metadata("design:returntype", Promise)
], GorillixActionProvider.prototype, "getTotalLiquidityTokenA", null);
__decorate([
    (0, actionDecorator_1.CreateAction)({
    ...
    __metadata("design:paramtypes", [wallet_providers_1.EvmWalletProvider, void 0]),
    __metadata("design:returntype", Promise)
], GorillixActionProvider.prototype, "getTotalLiquidityTokenB", null);
__decorate([
    (0, actionDecorator_1.CreateAction)({
    ...
    __metadata("design:paramtypes", [wallet_providers_1.EvmWalletProvider, void 0]),
    __metadata("design:returntype", Promise)
], GorillixActionProvider.prototype, "getLiquidityTokenAPerUser", null);
__decorate([
    (0, actionDecorator_1.CreateAction)({
    ...
    __metadata("design:paramtypes", [wallet_providers_1.EvmWalletProvider, void 0]),
    __metadata("design:returntype", Promise)
], GorillixActionProvider.prototype, "getLiquidityTokenBPerUser", null);
__decorate([
    (0, actionDecorator_1.CreateAction)({
    ...
    __metadata("design:paramtypes", [wallet_providers_1.EvmWalletProvider, void 0]),
    __metadata("design:returntype", Promise)
], GorillixActionProvider.prototype, "getLPTokensPerUser", null);
